 ...
 *	@description : Enter the data you want to insert, and where to insert it
 *	@param		 : L(the head node)
 *	@return		 : Status
 *  @notice      : None
 */
 ...
 *	@description : Enter the node data to delete and read the data for the node that will be deleted
 *	@param		 : p, e
 *	@return		 : Status
 *  @notice      : None
 */
 ...
 *	@description : Used to enter the data to find
 *	@param		 : L(the head node)
 *	@return		 : Status
 *  @notice      : None
 */
 ...
 *	@description : Recursively reverses the linked list
 *	@param		 : L(the head node)
 *	@return		 : Status
 *  @notice      : None
 */
